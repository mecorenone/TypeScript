...
describe("unittests:: tsserver:: packageJsonInfo::", () => {
    ...
    it("finds package.json on demand, watches for deletion, and removes them from cache", () => {
        ...
        projectService.getPackageJsonsVisibleToFile("/src/whatever/blah.ts");
    ...
    it("finds multiple package.json files when present", () => {
        ...
        assert.lengthOf(projectService.getPackageJsonsVisibleToFile("/a.ts"), 1);
        assert.lengthOf(projectService.getPackageJsonsVisibleToFile("/src/b.ts"), 2);
